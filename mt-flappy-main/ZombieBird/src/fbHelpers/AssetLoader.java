...
public class AssetLoader {
    ...
    public static TextureRegion pipeUp, pipeDown, bar, coinTex;
    ...
    public static void load() {
    	...
    	logoTexture = new Texture(Gdx.files.internal("data/mtsu.jpeg"));
        ...
        coinTex = new TextureRegion(texture, 152, 70, 10, 10);
        coinTex.flip(false, true);
